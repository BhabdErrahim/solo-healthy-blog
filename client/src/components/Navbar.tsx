...
const Navbar = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      desc: "Sanctuary engineering.",
    },
    {
      name: "Sport & Fitness",
      slug: "sport",
      icon: <Dumbbell className="w-5 h-5" />,
      desc: "Autonomous training.",
    },
    {
      name: "Food Recipes",
      slug: "food-recipes",
      icon: <Utensils className="w-5 h-5" />,
      desc: "Gourmet for one.",
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 group relative z-[1001]"
          >
          ...
          <div className="hidden md:flex items-center bg-white/40 backdrop-blur-md px-2 py-2 rounded-2xl border border-white/50 shadow-sm">
            <Link
              ...
              className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${
                pathname === "/"
                  ? "bg-[#114AB1] text-white shadow-md"
                  : "text-gray-700 hover:text-[#114AB1]"
              }`}
            >
              Home
            </Link>
            ...
            >
              <button
                className={`flex items-center gap-1 px-6 py-2.5 text-sm font-bold transition-all ${isMegaMenuOpen ? "text-[#114AB1]" : "text-gray-700 hover:text-[#114AB1]"}`}
              >
                Categories{" "}
                <ChevronDown
              ...
              <div
                className={`absolute top-full left-1/2 -translate-x-1/2 pt-4 transition-all duration-300 z-[1000] ${
                  isMegaMenuOpen
                ...
                <div className="w-[650px] bg-white shadow-[0_25px_70px_rgba(0,0,0,0.15)] rounded-[3rem] border border-gray-100 p-10 grid grid-cols-2 gap-6">
                  {categories.map((cat) => (
                    ...
                    >
                      ...
                      <div>
                        <h4 className="font-extrabold text-base text-[#114AB1] mb-1">
                          {cat.name}
                        </h4>
                        <p className="text-[11px] text-gray-500 leading-tight font-medium uppercase tracking-wider">
                          {cat.desc}
                        </p>
                      </div>
                    </Link>
                  ...
                  <div className="col-span-2 mt-4 pt-6 border-t border-gray-50">
                    <Link
                      href="/about"
                      className="flex items-center justify-center gap-3 text-xs font-black text-[#E4580B] uppercase tracking-[0.2em] hover:tracking-[0.3em] transition-all group"
                    >
                      Our Solo-Sovereignty Philosophy{" "}
                      <Zap
                        size={14}
          ...
          >
            <input
              ...
              className="pl-4 pr-12 py-2.5 rounded-2xl border border-gray-200 focus:outline-none focus:border-[#114AB1] transition-all w-48 lg:w-64 bg-white/80 backdrop-blur-sm"
            />
            <button
              type="submit"
              className="absolute right-1 top-1 bottom-1 w-10 flex items-center justify-center rounded-xl bg-[#114AB1] text-white hover:bg-[#E4580B] transition-all group"
            >
              <Search
                size={18}
